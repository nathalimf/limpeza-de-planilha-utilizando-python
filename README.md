...
Esse repositório contém um script em Python desenvolvido para automatizar o tratamento e a limpeza de dados de uma planilha de sinistros. O script lê as regras de exclusão de colunas de um arquivo de configuração externo e realiza diversos tratamentos de dados.
